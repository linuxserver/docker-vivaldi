pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'VIVALDI_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-vivaldi'
    CONTAINER_NAME = 'vivaldi'
    DOCKERHUB_IMAGE = 'linuxserver/vivaldi'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/vivaldi'
    PR_DOCKERHUB_IMAGE = 'lspipepr/vivaldi'
    DIST_IMAGE = 'debian'
    MULTIARCH = 'true'
    CI = 'true'
    CI_WEB = 'true'
  ...
  stages {
    ...
    stage("Set tag custom bash"){
      steps{
        script{
          env.EXT_RELEASE = sh(
            script: ''' curl -s -L https://repo.vivaldi.com/archive/deb/dists/stable/main/binary-amd64/Packages |grep -A 7 -m 1 'Package: vivaldi-stable' | awk -F ': ' '/Version/{print $2;exit}' ''',
            returnStdout: true).trim()
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-vivaldi/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-vivaldi\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-vivaldi\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Vivaldi\" \
          --label \"org.opencontainers.image.description=[Vivaldi](https://vivaldi.com/) is a Norwegian freeware, cross-platform web browser with a built-in email client developed by Vivaldi Technologies.\" \
